...
# Convertir el número binario a decimal e imprimirlo:
numero_binario_original = "1101"
numero_decimal_convertido = binario_a_decimal(numero_binario_original)
print(f"\nNúmero Binario Original: {numero_binario_original}")
print(f"Número Decimal Convertido: {numero_decimal_convertido}")
